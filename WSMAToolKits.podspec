...
Pod::Spec.new do |s|
  ...
  s.name         = "WSMAToolKits"
  s.version      = "0.0.4"
  s.summary      = "A short description of WSMAToolKits."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/WSMAToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/WSMAToolKits.git", :tag => "#{s.version}" }
